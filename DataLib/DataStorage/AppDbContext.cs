...
namespace DataLib.DataStorage
{
	public class AppDbContext : DbContext
	{
		...
		public DbSet<ItemListToItemJoin> ItemListToItemJoin { get; set; }
		...
		{
			modelBuilder.Entity<ItemListToItemJoin>().HasKey(item => new { item.ItemId, item.ItemListId});
		...
		private void SeedData(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<User>().HasData(
					new User() { FirstName = "Daniel", LastName = "Clark", PhoneNumber = "0123456789", Email = "Dani@gmail.com", UserName = "danielclark", Password ="pass", UserId = 1 },
					new User() { FirstName = "Joanna", LastName = "Janiak", PhoneNumber = "0123456789", Email = "joanna@gmail.com", UserName = "joanna janiak", Password = "pass", UserId = 2 },
					new User() { FirstName = "Lelland", LastName = "Turnbull", Email = "lelland@gmail.com", UserName = "lelland", Password = "pass", PhoneNumber = "0123456789", UserId = 3 }
			);	
			...
			modelBuilder.Entity<Item>().HasData(
						new Item() { ItemId = 1, ItemName = "iPhone 14", ItemDescription = "unused iPhone 14", ItemPrice = 1300, AddressId = 1, CategoryId = 1, Currency = Currency.EGP },
						new Item() { ItemId = 2, ItemName = "Samsung S22", ItemDescription = "unused Samsung S22", ItemPrice = 1200, AddressId = 4, CategoryId = 1, Currency = Currency.EURO }
			);



			modelBuilder.Entity<ItemList>().HasData(
				new ItemList(ItemListType.ForSaleByUser) { ItemListId = 1, UserId = 1 },
				new ItemList(ItemListType.FavoriteByUser) { ItemListId = 2, UserId = 1 },
				new ItemList(ItemListType.ForSaleByUser) { ItemListId = 3, UserId = 2 },
				new ItemList(ItemListType.FavoriteByUser) { ItemListId = 4, UserId = 2 },
				new ItemList(ItemListType.ForSaleByUser) { ItemListId = 5, UserId = 3 },
				new ItemList(ItemListType.FavoriteByUser) { ItemListId = 6, UserId = 3 }
				);

			modelBuilder.Entity<ItemListToItemJoin>().HasData(
				new ItemListToItemJoin { ItemId = 1, ItemListId = 1 },
				new ItemListToItemJoin { ItemId = 2, ItemListId = 1 }
				);
